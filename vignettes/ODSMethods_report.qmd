...
execute:
  ...
  message: false
vignette: >
  %\VignetteIndexEntry{ODSMethods Progress Report}
...
sim_path <- file.path(pkg_root, "vignettes", "mi_acml_summary_table_wide_b.csv")
...
# Analysis Example: Multiple Imputation

For MI, the phase-I data contain the longitudinal outcome and inexpensive
covariates for everyone, while the expensive continuous covariate is observed
only in the phase-II sample.
