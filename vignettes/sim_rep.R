...
library(mitools)
# library(ODS4LDA)
source("./vignettes/SimGenDatFns.R")
source("./vignettes/ImputationFns.R")
...
RunMods <- function(params,
  ...
  # dat.tmp   <- GenerateX(N=2000, n=ni[2], prev.grp=prev.grp, c.parm=conf.param)
...
write.csv(coef_int, "fit1_coef_int.csv")
write.csv(coef_slp, "fit1_coef_int.csv")
write.csv(se_int, "se_int.csv")
write.csv(se_slp, "se_slp.csv")
write.csv(rob_se_int, "rob_se_int.csv")
write.csv(rob_se_slp, "rob_se_slp.csv")
