...
#' @param ProfileCol the column number(s) for which we want fixed at the value of param.  Maximizing the log likelihood for all other parameters while fixing these columns at the values of InitVals at ProfileCol location.
